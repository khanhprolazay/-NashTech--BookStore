...
const classes: PageProps<any, any>["classes"] = {
    ...
    "kcBodyClass": "body",
    "kcFormClass": "form",
    "kcFormHeaderClass": "form-header",
    "kcHeaderWrapperClass": "header-wrapper",
    "kcLoginClass": "page-login",
    "kcFormOptionsWrapperClass": "form-options",
    "kcFormCardAccountClass": "card",
    "kcFormCardClass": "kc__form-card",
    "kcContentWrapperClass": "kc__content-wrapper",
    "kcInputClass": "kc__input",
    "kcButtonClass": "kc__button",
    "kcFormGroupClass": "kc__form-group",
    "kcButtonPrimaryClass": "kc__button--primary",
    "kcFormSocialAccountClass": "form",
    "kcFormSocialAccountListClass" : "form-social-account__list",
    "kcFormSocialAccountListLinkClass": "form-social-account__list-link",
    "kcFormSocialAccountContentClass": "form-social-account__content",
    "kcLabelWrapperClass": "kc__label-wrapper",
    "kcInputWrapperClass": "kc__input-wrapper",
    "kcFormOptionsClass": "kc__form-options",
    "kcFormButtonsClass": "kc__form-buttons",
};
