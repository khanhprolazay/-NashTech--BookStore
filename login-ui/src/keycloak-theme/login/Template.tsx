...
export default function Template(props: TemplateProps<KcContext, I18n>) {
	...
	return (
		<div
			...
			style={{
				justifyContent: imageNode ? "justify-between" : "justify-around",
			}}>
			...
			<div
				...
				style={cardStyles}>
				<div className={"col-xs-12 flex flex-col !p-0"}>
						...
						<header className={getClassName("kcFormHeaderClass")}>
							{!(
								...
								displayRequiredFields ? (
									...
									<h1 id="kc-page-title" style={{ textAlign: headerAlign }}>
										{headerNode}
									</h1>
								)
							) : displayRequiredFields ? (
								...
								{displayMessage &&
									...
									(message.type !== "warning" || !isAppInitiatedAction) && (
										<div className={clsx("alert", `alert-${message.type}`)}>
											...
											{message.type === "info" && (
												<span
													className={getClassName("kcFeedbackInfoIcon")}></span>
											)}
											<span
